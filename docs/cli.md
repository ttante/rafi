...
Options:
  ...
  --auto-compact-threshold <percent>  Builder or QA context threshold (1-99 percent)
  --compact-maximum <count>           Builder or QA successful compactions allowed per provider
                                      session
  -h, --help                          display help for command
```
