...
- Keep AI cost tracking and optimization notes updated in `{{docsRoot}}/ai-costs.md`.
...
- Document the journey toward custom model training in `{{docsRoot}}/ai.md`, including data requirements, quality thresholds, privacy constraints, retention rules, estimated cost, and when training is worth it.
